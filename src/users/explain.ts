import { Connection, getConnection, ObjectLiteral, QueryBuilder } from 'typeorm';
...
export const explain = async <T extends ObjectLiteral>(
    ...
    const explainParametersString = [...boolParameters, `FORMAT ${format.toUpperCase()}`].join(', ').toUpperCase();
